  ...
  return (
    <div>
      ...
      <div className={styles.firstGuideBox}>
        <div className={styles.guide}><span>계좌/카드</span> 연동 준비 중</div>
      </div>

      {/* 두 번째 가이드 */}
      <div className={`${styles.guideBox} ${fadeInStep >= 1 ? styles.fadeIn : ""}`}>
        <div className={styles.guide}><span>이번 달</span> 주문한 내역들은</div>
        <div className={styles.guide}><span>다음 달 1일</span>에 정산(<span>계좌이체</span>)</div>
      </div>
